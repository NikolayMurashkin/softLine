		...
		<section className={cx('business')}>
			...
			<div className={cx('business__content', 'content')}>
				<BusinessCard
					...
					image={'url("src/assets/images/business/1.jpg")'}
				/>
				<BusinessCard
					...
					image={'url("src/assets/images/business/2.jpg")'}
				/>
				<BusinessCard
					...
					image={'url("src/assets/images/business/3.jpg")'}
				/>
				<BusinessCard
					...
					image={'url("src/assets/images/business/4.jpg")'}
				/>
				<BusinessCard
					...
					image={'url("src/assets/images/business/5.jpg")'}
				/>
				<BusinessCard
					...
					image={'url("src/assets/images/business/6.jpg")'}
				/>
			</div>
		</section>
	);
